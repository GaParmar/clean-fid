...
# check the clean FID
score = fid.compute_fid(folder_real, folder_fake, mode="clean", batch_size=8, num_workers=20)
...
score = fid.compute_fid(folder_real, folder_fake, mode="legacy_pytorch", batch_size=8, num_workers=20)
...
score = fid.compute_fid(folder_real, folder_fake, mode="legacy_tensorflow", batch_size=8, num_workers=20)
